                ...
                {config.enable_aura_detection && (
                    <>
                        ...
                        <div className="form-row" style={{ marginTop: "10px" }}>
                            ...
                            <div className="form-group">
                                <label className="form-label">Minimum Rarity for Webhook</label>
                                <select
                                    className="form-input"
                                    value={config.aura_webhook_minimum_rarity || "0"}
                                    onChange={(e) => updateConfig("aura_webhook_minimum_rarity", e.target.value)}
                                    style={{ width: "180px" }}
                                >
                                    <option value="0">Any rolling aura</option>
                                    <option value="100000">1 in 100,000+</option>
                                    <option value="1000000">1 in 1,000,000+</option>
                                    <option value="10000000">1 in 10,000,000+</option>
                                    <option value="100000000">1 in 100,000,000+</option>
                                    <option value="1000000000">1 in 1,000,000,000+</option>
                                    <option value="10000000000">1 in 10,000,000,000+</option>
                                </select>
                                <small style={{ color: "var(--text-muted)", fontSize: "12px", display: "block", marginTop: "4px" }}>
                                    Non-rolling and unknown-rarity auras are always sent with their obtainment method.
                                </small>
                            </div>
                            <div className="form-group">
