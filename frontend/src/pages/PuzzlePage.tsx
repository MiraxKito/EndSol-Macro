...
const PUZZLES = [
    ...
    },
    {
        ...
        description: "A sequence of numbers was left behind. Each one points to a letter. Decode them and you'll have the final key. "
            + "The hint is somewhere out there... check the EndSol Server on discord!",
        answer: "dawnbreaker",
            ...
            {allDone && (
                <div className="card" style={{ textAlign: "center", padding: "24px" }}>
                    ...
                    <p style={{ color: "var(--text-secondary)", fontSize: "13px", marginBottom: "14px" }}>
                        Screenshot this and send it to <strong>@akiitosama</strong> on EndSol Development discord server to claim your role
                    </p>
                    <div style={{ fontFamily: "monospace", fontSize: "10px", opacity: 0.3, wordBreak: "break-all" }}>
                        {btoa(Date.now().toString(36) + "-endsol-" + Math.random().toString(36).slice(2, 6))}
                    </div>
                </div>
            )}
        </>
