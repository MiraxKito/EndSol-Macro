...
const SEARCH_INDEX = [
    ...
    { title: "Fishing", tab: "fishing", keywords: ["fish", "rod", "merchant teleporter", "fish failsafe", "sell all", "flarg", "minigame", "idle", "total fish caught"] },
    { title: "Merchant", tab: "merchant", keywords: ["merchant", "shop", "potions", "items", "buy", "teleport", "jester", "mari", "rin", "exchange"] },
    { title: "Auto Pop Buff", tab: "autopopbuff", keywords: ["auto pop", "buff", "potion", "fortune", "haste", "lucky", "speed", "universe", "heavenly", "oblivion", "custom items", "auto use"] },
    { title: "Auras", tab: "auras", keywords: ["aura", "record", "ping", "min rarity", "force", "clip", "user id", "keybind", "test", "global", "aura count", "total auras"] },
    { title: "Movements", tab: "movements", keywords: ["move", "walk", "jump", "obby", "macro", "path", "record", "replay"] },
...
export default function HeaderBar({ isRunning, onToggle, theme, onThemeChange, isGlitching, setActiveTab }: HeaderBarProps) {
    ...
    const handleImportConfig = async () => {
        ...
        try {
            ...
            const result = await window.pywebview.api.import_config() as { success: boolean; error?: string };
